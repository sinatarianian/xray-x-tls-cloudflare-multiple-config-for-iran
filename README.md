...
از لیست حتما Install in any combination رو انتخاب کنید که میشه گزینه دوم در منوی اسکریپت.

حتما با letsencrypt یه گواهی بسازید که با cloudflare وریفای بشه.

زمانی که به مرحله‌ای رسیدید که از شما درباره‌ cloudflare CNAME پرسید که میشه گزینه‌ 6/17 حتما گزینه‌ دو رو که دامنه who.int هست رو انتخاب کنید.
