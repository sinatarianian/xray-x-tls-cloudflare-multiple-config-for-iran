...
راهنمایی برای راه‌اندازی و تنظیم فیلترشکن v2ray xray برای ایران
...
از مزایای این تنظیمات اینه که نیازی به پیدا کردن آی‌پی تمیز برای کلودفلر نداره، با یه اسکریپت ساده هم میشه ۶ کانفیگ متفاوت خودکار روی پورت ۴۴۳ و TLS ساخت.
